...
class PageHeader extends React.Component {
  ...
  startPlay=()=>{ 
    ...
    this.state.snakeMoveTimer = setInterval(this.snakeMovement,this.state.speed);  
  }
    ...
    return (
      <div className="page-header header-filter">
        ...
        {/* <EndGame handler={this.playAgain} show={this.state.gameover} score={this.state.playerscore}/> */}
            ...
            <Col md="6"  className="content-title">
              <h1>Hi I'm Amit</h1>
              <h4>
              ...
              and try to keep pace with which the web is evolving. I also like to blog about what I learn or things which I find interesting.
